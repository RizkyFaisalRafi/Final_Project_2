...
public class PriaFormal extends AppCompatActivity {
        ...
        db.collection("Busana Pria - Formal")
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(PriaFormal.this, "data gagal diambil", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(e -> Toast.makeText(PriaFormal.this, "Gagal", Toast.LENGTH_SHORT).show());
    }
}
