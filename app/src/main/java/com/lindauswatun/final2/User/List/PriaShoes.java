...
public class PriaShoes extends AppCompatActivity {
        ...
        db.collection("Busana Pria - Shoes")
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(PriaShoes.this, "data gagal diambil", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(e -> Toast.makeText(PriaShoes.this, "Gagal", Toast.LENGTH_SHORT).show());
    }
}
