...
public class WanitaDress extends AppCompatActivity {
        ...
        db.collection("Busana Wanita - Dress")
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(WanitaDress.this, "data gagal diambil", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(e -> Toast.makeText(WanitaDress.this, "Gagal", Toast.LENGTH_SHORT).show());
    }
}
