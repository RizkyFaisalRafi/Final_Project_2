...
public class WanitaFormal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(view -> startActivity(new Intent(this, Wanita.class)));
        ...
        db.collection("Busana Wanita - Formal")
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(WanitaFormal.this, "data gagal diambil", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(e -> Toast.makeText(WanitaFormal.this, "Gagal", Toast.LENGTH_SHORT).show());
    }
}