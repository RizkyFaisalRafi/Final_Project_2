...
public class WanitaKaos extends AppCompatActivity {
        ...
        db.collection("Busana Wanita - Skirt")
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(WanitaKaos.this, "data gagal diambil", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(e -> Toast.makeText(WanitaKaos.this, "Gagal", Toast.LENGTH_SHORT).show());
    }
}
