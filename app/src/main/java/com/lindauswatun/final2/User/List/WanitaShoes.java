...
public class WanitaShoes extends AppCompatActivity {
        ...
        db.collection("Busana Wanita - Shoes")
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(WanitaShoes.this, "data gagal diambil", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(e -> Toast.makeText(WanitaShoes.this, "Gagal", Toast.LENGTH_SHORT).show());
    }
}
